...
%    \HRule \\[0.6cm]
    { \huge \bfseries
    Corrigé TD n$^{\boldsymbol{\circ}}$6
     \\ [0cm] }
    \HRule \\[0.5cm]
\end{center}
...
d. On a $m^a\equiv 4[31]$ et $e=d^{b}\equiv 4^{b}[4] \equiv 4[31]$. On en déduit que $b\equiv 1[5]$. Comme $\overline{b'}\in (\Z/30\Z)^\times$ on en déduit que $b\equiv 11[30]$ (par la question b.).  Par conséquent, $b'\equiv 11[30]$. Par la question 1., $m=e^{b'}$. On a donc $m\equiv 8^{11}[31]\equiv 2^{33}[31]\equiv 2^3[31]\equiv 8[31]$ donc $m=8$.
