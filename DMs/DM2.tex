...
\begin{center}
\textbf{A rendre  le lundi 8 décembre}
\end{center}
...
$t \equiv \omega [p_1^{\alpha_1}]$ et, pour tout $i \in \lb 2;k\rb$ (s'il en existe), $t \equiv 1 [p_i^{\alpha_i}]$.\\
...
\item[5.] On veut montrer le critère de Solovay-Strassen: soit $n\in \N_{\geq 3}$ impair. Alors $n$ est premier si et seulement si \begin{equation}\label{e_critere}
\left(\frac{a}{n}\right)\equiv a^{(n-1)/2} [n],\forall a\in \Z\mid a\wedge n =1.
